...
train_data = pd.read_csv("C:\\Users\\User\\data\\kaggle_house_pred_train.csv")
test_data = pd.read_csv("C:\\Users\\User\\data\\kaggle_house_pred_test.csv")
...
k, num_epochs, lr, weight_decay, batch_size = 8, 200, 3, 0, 64
